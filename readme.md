...
1. Recheck if monitoring interfaces works fine and needs optimization
...
4. What to do with neighbours, that are connected via multiple ethernet interfaces? and if each interface has its own NIC MAC address, is this still 1 neigbour?
